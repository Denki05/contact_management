...
class Contact extends Model
{
    ...
    {
        // Mengutamakan Existing Customer
        return $this->belongsTo(Customer::class, 'manage_id', 'id')
                    ->withDefault(function ($customer) {
                        // fallback ke CustomerProspek jika tidak ada
                        $prospek = CustomerProspek::find($this->manage_id);
                        return $prospek ?: new Customer;
                    });
    }
