...
<head>
    ...
    <style>
        ...
        h1 { text-align: center; margin-bottom: 2px; color: #222; }
        .sub-title { text-align: center; font-size: 11px; color: #555; margin-bottom: 15px; font-style: italic; }
        ...
        /* Modifikasi padding di th dan td */
        th { 
        ...
        td {
            /* Padding disesuaikan: atas 4, kanan 6, bawah 4, kiri 10px */
            padding: 4px 6px 4px 10px; 
        }

        /* 2. PENGHAPUSAN WARNA BARIS GENAP */
        /* Baris ini dihilangkan/dikosongkan agar tabel berwarna putih polos */
        /* tr:nth-child(even) td { background-color: #fafafa; } */
        
        .customer { font-weight: bold; font-size: 11px; color: #111; }
        .kegiatan { font-size: 10px; color: #555; margin-top: 2px; }
        
        .footer { text-align: center; font-size: 9px; color: #777; margin-top: 30px; border-top: 1px solid #ddd; padding-top: 5px; }
        
        /* PENYESUAIAN LEBAR KOLOM (Tidak ada perubahan, total 100%) */
